...
while(True):
    ...
    #applies guassian and bilateral filters if their corresponding flags are set
    if(gaussianFlag == 1):
...
print 'BEFORE MATCH PAIRS'+str(match_pairs)
...
print 'AFTER MATCH PAIRS'+str(match_pairs)
...
forward_values = ((160,86,163),(177,131,248))
backward_values = ((2,76,169),(50,128,236))
